      ...
      <form name="form1" method="post" action="nota.php">
        <table width="58%" border="0">
          ...
          <tr>
            ...
            <td><input class="form-control mb-2" type="text" name="jenis" id ="jenis" value="Turkish Dessert - Dessert Box" readonly="readonly" /></td>
          </tr>
          ...
          <tr>
            <td>Harga</td>
            <td><input class="form-control-plaintext mb-2" type="text" name="harga"  size="8" id ="harga" value="Rp 59.000" readonly="readonly" /></td>
          </tr>
          <tr>
            <td></td>
